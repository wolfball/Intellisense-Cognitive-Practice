...
def config_parser():
    ...
    parser.add_argument("--en_layers", type=int, default=1, help="num of encoder layers")
    parser.add_argument("--in_dim", type=int, default=28*28)
    parser.add_argument("--hid_dim", type=int, default=400, help="hidden size")
    parser.add_argument("--lat_dim", type=int, default=20, help="latent space dimension")
